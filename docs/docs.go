...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/progress/delete/{id}/{pgid}": {
            "delete": {
        ...
        "/api/v1/progress/update/{id}/{pgid}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Updated progress text",
                        "name": "text",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "JSON array of image URLs to keep",
                        "name": "image_urls",
                        "in": "formData"
                    },
                    {
